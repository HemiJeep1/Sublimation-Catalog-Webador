...
const productGroups = [
  {
    ...
    products: [
      ["Beach", "Beach.png"],
      ["Oil", "Castrol GTX OIL.jpg"],
      ["Corona Extra", "Corona Extra.jpg"],
      ["Two Collies", "Collie.png"],
      ["Life Is Better at the Beach", "THSP250424268 - Life is better at the Beach 2.png"],
      ["3D Palm Trees Beach Ocean", "3D Palm Trees Beach Ocean.png"],
      ["A&W Root Beer", "AW Root beer.jpg"],
      ["Summer Beach", "Life is better on the beach.png"],
      ["3D Highland Cow Beach", "3D Highland Cow Beach.png"],
      ["Three Havanese", "Havanese.png"],
  ...
  },
  {
    ...
    folder: "11 oz Mugs",
    products: [
      ["Mug Design Aging", "Aging.jpg"],
      ["Mug Design Coffee don't do miracles", "Coffee don't do miracles.jpg"],
      ["Mug Design Day drinking", "Day drinking.jpg"],
      ["Mug Design knit strangle people", "knit strangle people.jpg"],
      ["Mug Design Many tabs open", "Many tabs open.jpg"],
      ["Mug Design Mind own buisness", "Mind own buisness.jpg"],
      ["Mug Design Not bossy", "Not bossy.jpg"],
      ["Mug Design Not lazy", "Not lazy.jpg"],
      ["Mug Design Retired opinions", "Retired opinions.jpg"],
      ["Mug Design Said to myself", "Said to myself.jpg"],
      ["Mug Design Too old", "Too old.jpg"],
      ["Mug Design Wise Cracks", "Wise Cracks.jpg"],
      ["Mug Design Workday circus", "Workday circus.jpg"],
    ],
  },
  {
    category: "Tea Towels",
